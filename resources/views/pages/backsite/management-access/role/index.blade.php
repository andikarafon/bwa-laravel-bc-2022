...
<!-- BEGIN: Content-->
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            {{-- error --}}
            {{-- error ini akan muncul di bagian atas, jadi memudahkan user untuk mengetahui error yang terjadi --}}
            @if ($errors->any())
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.role.store') }}" method="POST" enctype="multipart/form-data"> {{-- enctype wajib ada di setiap inputan untuk menghandle input File --}}
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @if($role_item->id > 3) {{-- kenapa lebih dari 3, karena user admin tidak bisa dirubah --}}
                                                                                @can('role_delete')
